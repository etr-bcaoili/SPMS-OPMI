...
Public Class ReportSalesMatrix
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SPMS.ReportSalesMatrix.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportSalesMatrix
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportSalesMatrix = New ReportSalesMatrix
        rpt.Site = Me.Site
        Return rpt
    End Function
