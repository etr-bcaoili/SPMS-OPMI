...
Begin VB.Form FrmUploadDataGB 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "GB Distributor"
   ClientHeight    =   4635
   ClientLeft      =   4185
   ClientTop       =   3990
   ClientWidth     =   6285
   ...
   Begin MSComctlLib.ProgressBar ProgressBar1 
      ...
      BorderStyle     =   1
      Appearance      =   1
      MouseIcon       =   "FrmUploadDataGB.frx":0000
      Max             =   1000
      Scrolling       =   1
   End
   ...
   Begin VB.Image Image1 
      Height          =   1005
      Left            =   0
      Picture         =   "FrmUploadDataGB.frx":0CDA
      Stretch         =   -1  'True
      Top             =   -120
      Width           =   6405
   End
   ...
   End
End
Attribute VB_Name = "FrmUploadDataGB"
...
'FOR MDI
 ...
 End If
    ...
    Set cmdDeleteRawData = New ADODB.Command
        ...
        cmdDeleteRawData.Parameters.Append cmdDeleteRawData.CreateParameter("@CompanyCode", adVarChar, adParamInput, 10, "MDI")
 ...
 Else
    ...
    rsCheckRawDataFile.Open "Select * from UploadedRawData Where CheckFileName = '" & Right(txtfile, 12) & "' AND CompanyCode = '" & "MDI" & "'", cnn, adOpenKeyset
...
For i = 1 To ln
   ...
   If Trim(Mid(varx, 1, 2)) = "GB" Then
    ...
    Set cmdRawData = New ADODB.Command
        ...
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@CompanyCode", adVarChar, adParamInput, 10, "GB")
        ...
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@CustomerNumber", adVarChar, adParamInput, 10, Trim(Mid(varx, 19, 6)))
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@CustomerName", adVarChar, adParamInput, 255, Trim(Mid(varx, 25, 50)))
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@CustomerAddress1", adVarChar, adParamInput, 255, Trim(Mid(varx, 75, 50)))
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@CustomerAddress2", adVarChar, adParamInput, 255, "")
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@TransactionDate", adVarChar, adParamInput, 8, Trim(Mid(varx, 3, 8)))
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@InvoiceNumber", adVarChar, adParamInput, 10, Trim(Mid(varx, 11, 8)))
        If Trim(Mid(varx, 165, 9)) < 0 Then
        ...
        End If
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@ItemNumber", adVarChar, adParamInput, 20, Trim(Mid(varx, 125, 20)))
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@ItemDescription", adVarChar, adParamInput, 255, Trim(Mid(varx, 146, 20)))
        ...
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@QuantitySold", adInteger, adParamInput, , Trim(Mid(varx, 165, 9)))
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@QuantityFree", adInteger, adParamInput, , Trim(Mid(varx, 174, 9)))
        
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@GrossAmount", adDouble, adParamInput, , CDbl(Mid(varx, 192, 13)))
        ...
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@ProductDiscount", adDouble, adParamInput, , CDbl(Mid(varx, 212, 13)))
        ...
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@NetAmount", adDouble, adParamInput, , CDbl(Mid(varx, 225, 13)))
