...
Begin VB.Form FrmUploadDataWatsons 
   ...
   Begin MSComctlLib.ProgressBar ProgressBar1 
      ...
      BorderStyle     =   1
      Appearance      =   1
      MouseIcon       =   "FrmUploadDataWatsons.frx":0000
      Max             =   1000
      Scrolling       =   1
   End
   ...
   Begin VB.Image Image1 
      Height          =   1005
      Left            =   0
      Picture         =   "FrmUploadDataWatsons.frx":0CDA
      Stretch         =   -1  'True
      Top             =   -120
      Width           =   6285
   End
...
'FOR MDI
 ...
 End If
    ...
    Set cmdDeleteRawData = New ADODB.Command
        ...
        cmdDeleteRawData.Parameters.Append cmdDeleteRawData.CreateParameter("@CompanyCode", adVarChar, adParamInput, 10, "WAT")
    ...
    Set cmdDeleteBillingOrder = New ADODB.Command
        ...
        cmdDeleteBillingOrder.Parameters.Append cmdDeleteBillingOrder.CreateParameter("@CompanyCode", adVarChar, adParamInput, 10, "WAT")
    cmdDeleteBillingOrder.Execute
    
 Else
    
    If rsCheckRawDataFile.State = 1 Then rsCheckRawDataFile.Close
    rsCheckRawDataFile.Open "Select * from UploadedRawData Where CheckFileName = '" & Right(txtfile, 12) & "' AND CompanyCode = '" & "WAT" & "'", cnn, adOpenKeyset
...
For i = 1 To ln
   ...
   If CheckField(Trim(Mid(varx, 36, 50))) = "WATSONS PERSONAL CARE STORES PHILS., INC." Then
    ...
    Set cmdRawData = New ADODB.Command
        ...
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@CustomerDeliveryCode", adVarChar, adParamInput, 4, Trim(Mid(varx, 30, 6)))
