...
Begin VB.Form FrmUploadDataWatsons 
   BackColor       =   &H00FFFFFF&
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbFileType 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "FrmUploadDataWatsons.frx":0000
         Left            =   1080
         List            =   "FrmUploadDataWatsons.frx":000A
         TabIndex        =   15
         Top             =   240
         Width           =   1455
      End
      ...
      Begin MSComctlLib.ProgressBar ProgressBar1 
         ...
         BorderStyle     =   1
         Appearance      =   1
         MouseIcon       =   "FrmUploadDataWatsons.frx":001A
         Max             =   1000
         Scrolling       =   1
      End
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox cmbMonth 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "FrmUploadDataWatsons.frx":0CF4
         Left            =   1080
         List            =   "FrmUploadDataWatsons.frx":0CF6
         TabIndex        =   2
         Top             =   360
         Width           =   1455
      End
   ...
   Begin VB.Image Image2 
      Height          =   1005
      Left            =   0
      Picture         =   "FrmUploadDataWatsons.frx":0CF8
      Stretch         =   -1  'True
      Top             =   0
      Width           =   7125
   End
End
Attribute VB_Name = "FrmUploadDataWatsons"
...
'FOR MDI
 ...
 End If
    ...
    SQLConnect
     ...
     cnn.Execute "Delete From Rawdata Where CompanyCode = '" & "WAT" & "' AND CUTMO = '" & txtMonth.Text & "' AND CUTYEAR = '" & cmbYear.Text & "'"
    
    ProgressBar1.Visible = True
    ImportData
    
   ' cnn.Execute "Insert Into UploadedRawData(CompanyCode,CheckFileName) " & _
   '     " Values('" & "WAT" & "','" & Right(txtfile, 12) & "')"
   ...
   cnn.Execute "Insert Into UploadedRawData(CompanyCode,CheckFileName,Cutmo,Cutyear,TotalGrossAmount,TotalQuantity,TotalNetAmount,TotalProductDisc) " & _
        " Values('" & "WAT" & "','" & Right(txtfile, 12) & "','" & txtMonth.Text & "','" & cmbYear.Text & "'," & TotalGrossAmount & "," & TotalQuantity & "," & TotalNetAmount & "," & TotalProductDisc & " )"
...
For i = 1 To ln
    ...
    prn = Trim(Mid(strdata, 641, 3))
   ' If co = Strings.Left(cmbcomp.Text, 2) And prn = Trim(cmbprin.Text) Then
        
   If CheckField(Trim(Mid(varx, 36, 50))) = "WATSONS PERSONAL CARE STORES" Then
    ...
    Set cmdRawData = New ADODB.Command
        ...
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@CompanyCode", adVarChar, adParamInput, 10, "WAT")
        ...
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@CustomerNumber", adVarChar, adParamInput, 10, Trim(Mid(varx, 654, 3))) 'Trim(Mid(varx, 30, 6)))
...
'        End If
        ...
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@Route", adVarChar, adParamInput, 6, Trim(Mid(varx, 302, 6)))
        ...
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@Additional", adDouble, adParamInput, , CDbl(Mid(varx, 334, 13)) / 100)
'        If Trim(Mid(varx, 202, 2)) = "CR" Then
...
'        End If
        ...
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@ShipToName", adVarChar, adParamInput, 50, Trim(Mid(varx, 452, 50)))
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@ShipToAddress1", adVarChar, adParamInput, 50, Trim(Mid(varx, 502, 50)))
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@ShipToAddress2", adVarChar, adParamInput, 50, Trim(Mid(varx, 552, 50)))
        ...
        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@CustomerDeliveryCode", adVarChar, adParamInput, 10, Trim(Mid(varx, 654, 3)))
...
'        cmdRawData.Parameters.Append cmdRawData.CreateParameter("@Region", adVarChar, adParamInput, 20, rsRegion.Fields(0).Value)
'        End If
    
        cmdRawData.Execute
        
        cnn.Execute "UPDATE RAWDATA SET " & _
                "CUTMO = '" & txtMonth.Text & "' " & _
                "WHERE INVOICENUMBER = '" & Trim(Mid(varx, 194, 8)) & "' AND ITEMNUMBER = '" & Trim(Mid(varx, 204, 20)) & "' "
         cnn.Execute "UPDATE RAWDATA SET " & _
