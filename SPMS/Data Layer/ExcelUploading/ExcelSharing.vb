...
Public Class ExcelSharing
    ...
    Private m_ConfigtypeCode As String
    ...
    Public Function GetExcelData(ByVal _ExecelLocation As String) As DataTable
        ...
        Dim sqlSelect As String = "SELECT * FROM [Sharing per Channel$A9:P]  Where  [Company] like '" & CompanyCode & "';"
