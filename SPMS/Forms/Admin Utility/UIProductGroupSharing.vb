...
Public Class UIProductGroupSharing
    ...
    Private Sub LinkLabel2_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel2.LinkClicked
        ...
        OpenFileDialog1.Title = "Product Group Sharing"
    ...
    Private Sub Uploading()
        ...
        If Not ProductGroupSharingUploading.CheckUploadingFileExist(DropMonth.Text, DropYear.Text, txtConfigtypeCode.Text, txtChannelCode.Text) Then
            pbar.Visible = True
            For m As Integer = 0 To dt.Rows.Count - 1
                pbar.Value = ctr / dt.Rows.Count * 100
                Dim m_Sharing As New ProductGroupSharingUploading
                m_Sharing = New ProductGroupSharingUploading
                ...
                If IsDBNull(dr("Product Group")) Then
                    MsgBox("Product Group is Required", MsgBoxStyle.Exclamation, "Please Entry")
                    Exit Sub
                Else
                    m_Sharing.ProductGroupCode = dr("Product Group")
                End If
                ...
                m_Sharing.CRTBY = MainWindow.MainUserName
            ...
            UploadSuccess()
        Else
            ProductGroupSharingUploading.DeleteExistList(DropMonth.Text, DropYear.Text, txtConfigtypeCode.Text, txtChannelCode.Text)
            pbar.Visible = True
            For m As Integer = 0 To dt.Rows.Count - 1
                pbar.Value = ctr / dt.Rows.Count * 100
                Dim m_Sharing As New ProductGroupSharingUploading
    ...
    Private Sub UIProductGroupSharing_Load(sender As Object, e As EventArgs) Handles Me.Load
        LoadYear()
    End Sub
End Class