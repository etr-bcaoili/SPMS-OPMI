...
Public Class CustMapping
    ...
    Private Sub UploadFile()
        ...
        Try
            ...
            If txtFileName.Text = "PRICELIST" Then
    ...
    Private Sub Uploading()
        ...
        If Not SharingCompany.CheckIfItempriceListDataExist(cbocompany.Text, cboYear.Text, cboMonth.Text) Then
            pbar.Visible = True
            ...
            delete_aLL_In_Container1()
        Else
            SharingCompany.DeleteExistIfitempriceList(cbocompany.Text, cboYear.Text, cboMonth.Text)
            pbar.Visible = True
            For m As Integer = 0 To dt.Rows.Count - 1
                pbar.Value = ctr / dt.Rows.Count * 100
                Dim m_Sharing As New SharingCompany
    ...
    Private Sub Delete()
        ...
        End If
    End Sub
    Private Sub delete_aLL_In_Container1()
        m_RsYear = New ADODB.Recordset
        m_RsYear.Open("Delete  from SharingCompany where  CUTYEAR='" & cboYear.Text & "' AND CUTMO= '" & cboMonth.Text & "' AND COMID= '" & cbocompany.Text & "'", ConnectionModule.SPMSConn, ADODB.CursorTypeEnum.adOpenStatic, ADODB.LockTypeEnum.adLockReadOnly)
    End Sub
    Private Sub deletecompany()
        m_RsYear = New ADODB.Recordset
        m_RsYear.Open("Delete  from SharingCompany", ConnectionModule.SPMSConn, ADODB.CursorTypeEnum.adOpenStatic, ADODB.LockTypeEnum.adLockReadOnly)
    End Sub
    ...
    Private Sub CreateSharing()
        m_RsYear = New ADODB.Recordset
        m_RsYear.Open("Insert into sharing (CUTYEAR, CUTMO, COMID, CUSCD, CUSNAM,CDACD, CDANAME, TERRCD, STSLSMNCD, STSLSMNNAME,ITEMDIVCD, PERSHR, DELFLAG, IsActive) select CUTYEAR, CUTMO, COMID, CUSCD, CUSNAM,CDACD, CDANAME, TERRCD, STSLSMNCD, STSLSMNNAME,ITEMDIVCD, PERSHR, DELFLAG, IsActive  from SharingCompany ", ConnectionModule.SPMSConn, ADODB.CursorTypeEnum.adOpenStatic, ADODB.LockTypeEnum.adLockReadOnly)
    End Sub
