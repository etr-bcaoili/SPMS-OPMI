...
Public Class UCReportPerformanceMonthWise_DistrictProductWise
    ...
    Private Sub LoadData1()
        ...
        UCReportPerformanceMonthWise_DistrictProductWise.CheckForIllegalCrossThreadCalls = False
        Label8.Text = "Generate . . . ..."


        Connect()
        Dim cmd As New SqlCommand("uspPerformanceMonthWise_DistrictProductWise", SPMSConn2)
