...
Public Class UCReportPerformanceMonthWise_TerritoryProductWise
    Dim ThreadLoadData As Thread
    Dim ThreaGenerateReport As Thread
    Dim ThreadGenerateExcel As Thread
    ...
    Private Function ValidataData() As Boolean
        ...
        If cmbEndYear.Text = String.Empty Then
            m_Err.SetError(cmbEndYear, "EndMonth is Required")
            m_HasError = True
        End If
        If cmbEndYear.Text = String.Empty Then
            m_Err.SetError(cmbEndMonth, "EndYear is Required")
            m_HasError = True
        End If
    ...
    Private Sub LoadData1()
        ...
        UCReportPerformanceMonthWise_TerritoryProductWise.CheckForIllegalCrossThreadCalls = False
        Label8.Text = "Generate . . . ."

        Connect()
        Dim cmd As New SqlCommand("uspPerformanceMonthwise_TerritoryProductwise", SPMSConn2)
    ...
    Private Sub btnExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        ThreadGenerateExcel = New Thread(New ThreadStart(AddressOf Export))
        ThreadGenerateExcel.Start()
        'Export()
    End Sub
