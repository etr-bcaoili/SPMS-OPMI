...
Public Class UCPerformanceTerritoryWise
    ...
    Private Sub LoadData1()
        ...
        UCPerformanceTerritoryWise.CheckForIllegalCrossThreadCalls = False
        ...
        Connect()
        Dim cmd As New SqlCommand("uspPerformanceMonthWise_TerritoryWise", SPMSConn2)
        ...
        Dim CommmandBuilding As New SqlCommandBuilder(dataAdapter)
        table = New DataTable
        table.Locale = System.Globalization.CultureInfo.InvariantCulture
