...
Public Class UCReportSalesAchievementTransactionTypeWise
    ...
    Private Sub RefreshData()
        ...
        GetData("EXEC USPSalesAchievementTransactionTypeWisePerDate @MonthFrom=" & cmbStartMonth.Text & ",  @YearFrom=" & cmbStartYear.Text & ", @MonthTo=" & cmbEndMonth.Text & ",  @YearTo=" & cmbEndYear.Text & " ")
    ...
    Private Sub Export()
        ...
        objSheet.Range("A2", "A4").Font.Size = 14
        objSheet.Range("A2", "A4").Font.Bold = True
        objExcel.Cells(2, 1).value = "Glenmark Philippines Inc."
        objExcel.Cells(3, 1).value = "Sales Achievement-Territory Wise"
        objExcel.Cells(4, 1).value = "Date Range: " & cmbStartYear.Text & " " & cmbStartMonth.Text & " To " & cmbEndYear.Text & " " & cmbEndMonth.Text


        For i As Integer = 0 To table.Columns.Count - 1
            objExcel.Cells(6, i + 1).value = table.Columns(i).ColumnName
        Next
        For i As Integer = 7 To table.Rows.Count + 6
            Dim dr As DataRow = table.Rows(i - 7)
