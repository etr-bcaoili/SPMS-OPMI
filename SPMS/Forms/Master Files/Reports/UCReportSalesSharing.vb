...
Public Class UCReportSalesSharing
    ...
    Private Sub btnPrintPreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrintPreview.Click
        ...
        GetData("SELECT * FROM VwSalesSharing ORDER BY ChannelCode, CustomerCode, ShiptoCode, ShiptoName, Territory, SalesAgentCode, SalesAgentname")
    End Sub
    ...
    Private Sub Export()
        ...
        objBook.SaveAs("Sales Sharing Report", Excel.XlFileFormat.xlWorkbookNormal, System.Reflection.Missing.Value, System.Reflection.Missing.Value, True, False, Excel.XlSaveAsAccessMode.xlNoChange, False, False, System.Reflection.Missing.Value, System.Reflection.Missing.Value, System.Reflection.Missing.Value)
        Exit Sub
errHandler:
