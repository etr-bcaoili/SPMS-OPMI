...
Public Class UCReportSalesSummaryAllTerritory
    ...
    Private Sub RefreshData()
        ...
        If Not chkExclude.Checked Then
            GetData(" EXECUTE uspSPMSGPISalesSummaryTerritoryAll @BeginMonth='" & cmbStartMonth.Text & "',  @BeginYear=" & cmbStartYear.Text & ", @EndMonth='" & cmbEndMonth.Text & "',  @EndYear=" & cmbEndYear.Text & " ")
        Else
            GetData(" EXECUTE uspSPMSGPISalesSummaryTerritoryAllwithExclusion @BeginMonth='" & cmbStartMonth.Text & "',  @BeginYear=" & cmbStartYear.Text & ", @EndMonth='" & cmbEndMonth.Text & "',  @EndYear=" & cmbEndYear.Text & " ")
        End If
    ...
    Private Sub Export()
        ...
        objSheet.Name = "Sales Summary All Territory"
        ...
        objBook.SaveAs("Sales Summary All territory", Excel.XlFileFormat.xlWorkbookNormal, System.Reflection.Missing.Value, System.Reflection.Missing.Value, True, False, Excel.XlSaveAsAccessMode.xlNoChange, False, False, System.Reflection.Missing.Value, System.Reflection.Missing.Value, System.Reflection.Missing.Value)
        Exit Sub
errHandler:
