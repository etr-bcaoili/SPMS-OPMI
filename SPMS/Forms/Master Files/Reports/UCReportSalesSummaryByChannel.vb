...
Public Class UCReportSalesSummaryByChannel
    ...
    Private Sub RefreshData()
        ...
        If Not chkExclude.Checked Then
            GetData(" EXECUTE uspSPMSGPISalesSummaryChannel @BeginMonth='" & cmbStartMonth.Text & "',  @BeginYear=" & cmbStartYear.Text & ", @EndMonth='" & cmbEndMonth.Text & "',  @EndYear=" & cmbEndYear.Text & " ")
        Else
            GetData(" EXECUTE uspSPMSGPISalesSummaryChannelwithExclusion @BeginMonth='" & cmbStartMonth.Text & "',  @BeginYear=" & cmbStartYear.Text & ", @EndMonth='" & cmbEndMonth.Text & "',  @EndYear=" & cmbEndYear.Text & " ")
        End If
    ...
    Private Sub Export()
        ...
        objBook.SaveAs("Sales Summary by Channel", Excel.XlFileFormat.xlWorkbookNormal, System.Reflection.Missing.Value, System.Reflection.Missing.Value, True, False, Excel.XlSaveAsAccessMode.xlNoChange, False, False, System.Reflection.Missing.Value, System.Reflection.Missing.Value, System.Reflection.Missing.Value)
        Exit Sub
errHandler:
        objExcel.Quit()
    End Sub
