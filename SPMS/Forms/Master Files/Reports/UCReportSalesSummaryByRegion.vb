...
Public Class UCReportSalesSummaryByRegion
    ...
    Private Sub RefreshData()
        ...
        If Not chkExclude.Checked Then
            GetData(" EXECUTE uspSPMSGPISalesSummaryRegion @BeginMonth='" & cmbStartMonth.Text & "',  @BeginYear=" & cmbStartYear.Text & ", @EndMonth='" & cmbEndMonth.Text & "',  @EndYear=" & cmbEndYear.Text & " ")
        Else
            GetData(" EXECUTE uspSPMSGPISalesSummaryRegionwithExclusion @BeginMonth='" & cmbStartMonth.Text & "',  @BeginYear=" & cmbStartYear.Text & ", @EndMonth='" & cmbEndMonth.Text & "',  @EndYear=" & cmbEndYear.Text & " ")
        End If
    ...
    Private Sub Export()
        ...
        objSheet.Name = "Sales Summary per Region"
        ...
        objBook.SaveAs("Sales Summary per region", Excel.XlFileFormat.xlWorkbookNormal, System.Reflection.Missing.Value, System.Reflection.Missing.Value, True, False, Excel.XlSaveAsAccessMode.xlNoChange, False, False, System.Reflection.Missing.Value, System.Reflection.Missing.Value, System.Reflection.Missing.Value)
        Exit Sub
errHandler:
