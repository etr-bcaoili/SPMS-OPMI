...
Public Class UCReportSalesSummaryPerProduct
    ...
    Private Sub RefreshData()
        ...
        GetData(" EXECUTE uspSPMSGPISalesSummaryProductAll @BeginMonth='" & cmbStartMonth.Text & "',  @BeginYear=" & cmbStartYear.Text & ", @EndMonth='" & cmbEndMonth.Text & "',  @EndYear=" & cmbEndYear.Text & " ")
