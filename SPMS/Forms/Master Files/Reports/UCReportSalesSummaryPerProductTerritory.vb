...
Public Class UCReportSalesSummaryPerProductTerritory
    ...
    Private Sub btnPrintPreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrintPreview.Click
        ...
        GetData(" EXECUTE uspSPMSGPISalesSummaryProductTerritory @BeginMonth='" & cmbStartMonth.Text & "',  @BeginYear=" & cmbStartYear.Text & ", @EndMonth='" & cmbEndMonth.Text & "',  @EndYear=" & cmbEndYear.Text & ", @TerrCode = '" & cmbterritorycode.Text & "'  ")
    ...
    Private Sub Export()
        ...
        objSheet.Name = "Sales Summary per Product"
        ...
        objBook.SaveAs("Sales Summary per Product", Excel.XlFileFormat.xlWorkbookNormal, System.Reflection.Missing.Value, System.Reflection.Missing.Value, True, False, Excel.XlSaveAsAccessMode.xlNoChange, False, False, System.Reflection.Missing.Value, System.Reflection.Missing.Value, System.Reflection.Missing.Value)
        Exit Sub
errHandler:
    ...
    Private Function Rsterritory(Optional ByVal Filter As String = "") As ADODB.Recordset
    ...
    Private Function RsGpiCalendarYear(Optional ByVal Filter As String = "") As ADODB.Recordset
        ...
        If Filter <> "" Then
            Filter = " AND " & Filter
        End If
        'rs.Open("SELECT DISTINCT CAYR FROM CALENDAR WHERE COMID = 'GPI' " & Filter, SPMSConn, ADODB.CursorTypeEnum.adOpenStatic, ADODB.LockTypeEnum.adLockReadOnly)
    ...
    Private Sub PopulateComboBox()
        ...
        cmbterritorycode.Items.Clear()
        cmbterritorydesc.Items.Clear()
        'for the territory
        rs = Rsterritory()
        If rs.RecordCount > 0 Then
            For i As Integer = 1 To rs.RecordCount
                cmbterritorycode.Items.Add(rs.Fields("Stterrcd").Value)
                cmbterritorydesc.Items.Add(rs.Fields("StacovName").Value)
                rs.MoveNext()
            Next
        End If
    ...
    Private Sub cmbterritorycode_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbterritorycode.SelectedIndexChanged
        Dim rs As New ADODB.Recordset
        rs = Rsterritory("Stterrcd = '" & cmbterritorycode.Text & "' ")
        If rs.RecordCount > 0 Then
            cmbterritorydesc.Text = rs.Fields("Stacovname").Value
        End If
    End Sub

    Private Sub cmbterritorydesc_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbterritorydesc.SelectedIndexChanged
        Dim rs As New ADODB.Recordset
        rs = Rsterritory("Stacovname = '" & cmbterritorydesc.Text & "' ")
        If rs.RecordCount > 0 Then
            cmbterritorycode.Text = rs.Fields("stterrcd").Value
        End If
    End Sub
