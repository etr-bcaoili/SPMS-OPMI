...
Public Class UCReportSalesSummarybySalesCategory
    ...
    Private Sub RefreshData()
        ...
        GetData("EXECUTE uspSPMSGPISalesSummarySalesCategory @BeginMonth ='" & cmbStartMonth.Text & "',  @BeginYear=" & cmbStartYear.Text & ", @EndMonth='" & cmbEndMonth.Text & "',  @EndYear=" & cmbEndYear.Text & " ")
    ...
    Private Sub Export()
        ...
        objSheet.Name = "Sales Summary Sales Category "
        ...
        objBook.SaveAs("Sales Summary Sales Category", Excel.XlFileFormat.xlWorkbookNormal, System.Reflection.Missing.Value, System.Reflection.Missing.Value, True, False, Excel.XlSaveAsAccessMode.xlNoChange, False, False, System.Reflection.Missing.Value, System.Reflection.Missing.Value, System.Reflection.Missing.Value)
        Exit Sub
errHandler:
