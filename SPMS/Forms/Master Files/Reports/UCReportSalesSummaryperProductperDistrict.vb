...
Public Class UCReportSalesSummaryperProductperDistrict
    ...
    Private Sub btnPrintPreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrintPreview.Click
        ...
        GetData(" EXECUTE uspSPMSGPISalesSummaryProductDistrict @BeginMonth='" & cmbStartMonth.Text & "',  @BeginYear=" & cmbStartYear.Text & ", @EndMonth='" & cmbEndMonth.Text & "',  @EndYear=" & cmbEndYear.Text & ", @DistrictCode = '" & cmbdistrictcode.Text & "'  ")
...
errHandler:
    ...
    Private Function RsDistrict(Optional ByVal Filter As String = "") As ADODB.Recordset
        ...
        rs.Open("SELECT * FROM StDISTRICT WHERE DLTFLG = 0 " & Filter, SPMSConn, ADODB.CursorTypeEnum.adOpenStatic, ADODB.LockTypeEnum.adLockReadOnly)
        Return rs
    End Function
    ...
    Private Sub PopulateComboBox()
        ...
        cmbdistrictDescription.Items.Clear()
        'for the year   
        ...
        If rs.RecordCount > 0 Then
            For i As Integer = 1 To rs.RecordCount
                ...
                cmbdistrictDescription.Items.Add(rs.Fields("stDistrctName").Value)
                rs.MoveNext()
            Next
        End If
    End Sub
    ...
    Private Sub cmbdistrictcode_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbdistrictcode.SelectedIndexChanged
        Dim rs As New ADODB.Recordset
        rs = RsDistrict("stDistrctcd = '" & cmbdistrictcode.Text & "'")
        If rs.RecordCount > 0 Then
            cmbdistrictDescription.Text = rs.Fields("stDistrctName").Value
        End If
    End Sub

    Private Sub cmbdistrictDescription_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbdistrictDescription.SelectedIndexChanged
        Dim rs As New ADODB.Recordset
        rs = RsDistrict("stDistrctname = '" & cmbdistrictDescription.Text & "' ")
        rs.Filter = "stDistrctcd='" & cmbdistrictcode.Text & "'"
        If rs.RecordCount <= 0 Then rs.Filter = ""
        If rs.RecordCount > 0 Then
