...
Public Class UCReportSalesSummaryperTerritoryDistrict
    ...
    Private Sub btnPrintPreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrintPreview.Click
        ...
        GetData(" EXECUTE uspSPMSGPISalesSummaryTerritoryDistrict @BeginMonth='" & cmbStartMonth.Text & "',  @BeginYear=" & cmbStartYear.Text & ", @EndMonth='" & cmbEndMonth.Text & "',  @EndYear=" & cmbEndYear.Text & ", @DistrictCode = '" & cmbdistrictcode.Text & "'  ")
    ...
    Private Sub Export()
        ...
        objSheet.Name = " TerritoryDistrict"
        ...
        objBook.SaveAs("Sales Summary by territoryDistrict", Excel.XlFileFormat.xlWorkbookNormal, System.Reflection.Missing.Value, System.Reflection.Missing.Value, True, False, Excel.XlSaveAsAccessMode.xlNoChange, False, False, System.Reflection.Missing.Value, System.Reflection.Missing.Value, System.Reflection.Missing.Value)
        Exit Sub
errHandler:
    ...
    Private Sub PopulateComboBox()
        ...
        If rs.RecordCount > 0 Then
            For i As Integer = 1 To rs.RecordCount
                ...
                cmbdistrictdesc.Items.Add(rs.Fields("stDistrctName").Value)
                rs.MoveNext()
            Next
        End If
    End Sub
    ...
    Private Sub cmbdistrictcode_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbdistrictcode.SelectedIndexChanged
        ...
        If rs.RecordCount > 0 Then
            cmbdistrictdesc.Text = rs.Fields("stDistrctName").Value
        End If
    End Sub

    Private Sub cmbdistrictDescription_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbdistrictdesc.SelectedIndexChanged
        Dim rs As New ADODB.Recordset
        rs = RsDistrict("stDistrctname = '" & cmbdistrictdesc.Text & "' ")
