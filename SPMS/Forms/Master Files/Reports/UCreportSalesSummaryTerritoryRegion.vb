...
Public Class UCreportSalesSummaryTerritoryRegion


    Private bindingSource1 As New BindingSource()
    Private dataAdapter As New SqlDataAdapter()
    Private table As New DataTable()
    Private c_Region As String
    ...
    Private Sub btnPrintPreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrintPreview.Click
        ...
        GetData(" EXECUTE uspSPMSGPISalesSummaryTerritoryRegion @RegionCode='" & c_Region & "', @BeginMonth='" & cmbStartMonth.Text & "',  @BeginYear=" & cmbStartYear.Text & ", @EndMonth='" & cmbEndMonth.Text & "',  @EndYear= " & cmbEndYear.Text)
...
errHandler:
    ...
    Private Function RsGpiCalendarYear(Optional ByVal Filter As String = "") As ADODB.Recordset
        ...
        Return rs
    End Function
    Private Function RsRegion() As ADODB.Recordset
        Dim rs As New ADODB.Recordset
        Dim j
    ...
    Private Sub cmbRegion_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbRegion.SelectedIndexChanged
        ...
        c_Region = rs.Fields("STREGCD").Value
