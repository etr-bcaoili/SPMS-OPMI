...
Public Class ucSalesSummaryChannelPerCustomer
    ...
    Private Sub LoadCompany()
        dv.Table = GetRecords("select distinct distcomid from Distributor where DISTCOMID <> 'MER'")
    ...
    Private Sub LoadData()
        ucSalesSummaryChannelPerCustomer.CheckForIllegalCrossThreadCalls = False
        Dim PrevComid As String = String.Empty
        Dim Rw As Integer = 0
        dv.Table = GetRecords("EXEC uspSalesSummaryPerChannelPerCustomer @Year =" & cmbYear.Text & ", @Month =" & cmbMonth.Text & ", @Comid='" & cmbCompany.Text & "'")
