...
Public Class ucSalesTransactionByTransactionType

    Private bindingSource1 As New BindingSource()
    Private dataAdapter As New SqlDataAdapter()
    Private table As New DataTable()
    Private c_TransactionType As String
    ...
    Private Function ValidataData() As Boolean
        ...
        If cmbTransactionType.Text = String.Empty Then
            m_Err.SetError(cmbTransactionType, "Transaction Type is required")
            m_HasError = True
        End If
    ...
    Private Sub btnPrintPreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrintPreview.Click
        ...
        If ValidataData() Then
            If Not chkExclude.Checked Then
                GetData(" EXECUTE uspSPMSGPISalesTransactionListForThePeriodOFByTransType @TransactionType='" & cmbTransactionType.Text & "', @BeginMonth=" & cmbStartMonth.Text & ",  @BeginYear=" & cmbStartYear.Text & ", @EndMonth=" & cmbEndMonth.Text & ",  @EndYear= " & cmbEndYear.Text)
            Else
                GetData(" EXECUTE uspSPMSGPISalesTransactionListForThePeriodOfByTransTypewithExclusion @TransactionType='" & cmbTransactionType.Text & "', @BeginMonth=" & cmbStartMonth.Text & ",  @BeginYear=" & cmbStartYear.Text & ", @EndMonth=" & cmbEndMonth.Text & ",  @EndYear= " & cmbEndYear.Text)
            End If
        End If
    ...
    Private Sub Export()
        ...
        objSheet.Name = "Sales Transaction By TransType"
        ...
        objBook.SaveAs("Sales Transaction By Transaction Type", Excel.XlFileFormat.xlWorkbookNormal, System.Reflection.Missing.Value, System.Reflection.Missing.Value, True, False, Excel.XlSaveAsAccessMode.xlNoChange, False, False, System.Reflection.Missing.Value, System.Reflection.Missing.Value, System.Reflection.Missing.Value)
        Exit Sub
errHandler:
    ...
    Private Function RsGpiCalendarYear(Optional ByVal Filter As String = "") As ADODB.Recordset
        ...
        Return rs
    End Function
    Private Function TransactionType() As ADODB.Recordset
        Dim rs As New ADODB.Recordset
        Dim j
        rs.Open("SELECT DISTINCT TRANSACTIONTYPE FROM CUST_DIV_ITEM_SALES", SPMSConn, ADODB.CursorTypeEnum.adOpenStatic, ADODB.LockTypeEnum.adLockReadOnly)
        For j = 1 To rs.RecordCount
            cmbTransactionType.Items.Add(rs.Fields("TRANSACTIONTYPE").Value)
            rs.MoveNext()
        Next
        Return rs
    End Function
