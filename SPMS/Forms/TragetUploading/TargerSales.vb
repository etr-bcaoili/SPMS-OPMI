...
Public Class TargerSales
    ...
    Public Function Save() As Boolean
        Connect()
        Try
            Dim cmd As New SqlCommand("uspSalesTargetTemp", SPMSConn2)
    ...
    Private Shared Function BaseFilter(ByVal table As System.Data.DataTable) As TargerSalesCollection
        Dim col As New TargerSalesCollection
        For j As Integer = 0 To table.Rows.Count - 1
            Dim m_RawData As New TargerSales
    ...
    Public Shared Function Filter(ByVal Condition As String) As TargerSalesCollection
        Return BaseFilter(GetRecords("SELECT * FROM SalesTargetTemp " & IIf(Condition <> "", " WHERE " & Condition, "")))
    End Function

    Public Overloads Shared Function Load() As TargerSalesCollection
        Return Filter("")
    End Function

    Public Overloads Shared Function Load(ByVal TargetSaleID As Integer) As TargerSales
    ...
    Public Shared Function CheckIfRawDataExist(ByVal Year As String, ByVal ConfigtypeCode As String) As Boolean
        Return ExecuteCommand("DELETE FROM TerritoryItemTarget WHERE  Year = '" & Year & "' and ConfigTypeCode = '" & ConfigtypeCode & "'")
    End Function
    ...
    'End Function
    Public Shared Function CheckIfDataExist(ByVal ItemCode As String, ByVal ItemDivisionCode As String, ByVal Config As String) As Boolean
        Return ExecuteCommand("SELECT 'A' FROM TerritoryItemTarget Where ITEMCD = '" & ItemCode & "' AND ItemDivisionCode = '" & ItemDivisionCode & "' AND ConfigTypeCode = '" & Config & "'") = "A"
    End Function
    Public Shared Function CheckDeleteTargetPerItemExist(ByVal ItemCode As String, ByVal ItemDivisionCode As String, ByVal Config As String) As Boolean
        Return ExecuteCommand("DELETE FROM TerritoryItemTarget WHERE  ITEMCD = '" & ItemCode & "' and ItemDivisionCode = '" & ItemDivisionCode & "' AND ConfigTypeCode =  '" & Config & "'")
    End Function

    Public Shared Function DeleteExistRawData(ByVal CompanyCode As String) As Boolean
        Return ExecuteCommand("DELETE FROM SalesTargetTemp Where Comid = '" & CompanyCode & "'")
    End Function
    Public Class TargerSalesCollection
        Inherits List(Of TargerSales)
    End Class
